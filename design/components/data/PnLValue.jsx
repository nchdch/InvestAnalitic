...
const ArrowUp = () => (<svg className="ia-pnl__arrow" viewBox="0 0 12 12" fill="none"><path d="M6 9.5V2.5M6 2.5L2.5 6M6 2.5L9.5 6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>)
const ArrowDown = () => (<svg className="ia-pnl__arrow" viewBox="0 0 12 12" fill="none"><path d="M6 2.5v7M6 9.5L2.5 6M6 9.5L9.5 6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>)
...
export function PnLValue({
  value = 0,
  percent = null,
  display = 'both',     // 'money' | 'percent' | 'both'
  size = 'md',
  arrow = true,
  badge = false,
